...
CHECKS=(biome typescript filesize complexity comments colors search gitleaks pii language emoji async editorconfig dangerous-patterns filenames deps types-colocation clean-root no-hardcoded-secrets interface-segregation traceability)
TOTAL=${#CHECKS[@]}
START_TIME=$(date +%s)
